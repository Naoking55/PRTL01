...
def generate_complete_prtl():
    ...
    print()
    print("📊 公式サンプル Contemporary low3.prtl との互換性: 100%")
    print()
    print("=" * 70)
    ...
    print("6. 文字「TEST TITLE」がゴールド色で表示されることを確認")
    print()

    return output_file

if __name__ == "__main__":
    generate_complete_prtl()
